...
export default function Course180Hypo() {
        ...
        <div className="text-Chocolate flex flex-col gap bg-white shadow-2xl items-center w-80 p-6 gap-5 rounded-3xl ">
            ...
            />
                ...
                <div className='flex flex-col items-center gap-2 justify-evenly'>
                    <h1 className='text-xl font-bold'>#180 Hypobaric Safety</h1>
                    <h2 className='text-lg'>In Person</h2>
                </div>
                <div>
                <Link href="/aerospace/courses/hypobaricsafetyspecialist"><Button backgroundColor="Eggshell">See Syllabus</Button></Link>
                </div>
        </div>
    );
}
