...
const RegisterForm = () => {
  ...
  const courses = [
    ...
    "#110 Hyperbaric Core Competencies (April 8-10,)",
    "#130 Monoplace Chamber Operator (April 6-7)",
    ...
    "#180 Hyperbaric Safety (April 25-26)",
    "#190 Inspection and Maintenance of Acrylics (April 27)"
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-xl flex flex-col items-center mx-auto p-6 space-y-6 border border-gray-300 shadow-md rounded-lg bg-white">
      <h2 className="text-2xl font-bold">Request Package Information</h2>
      ...
      <p className="text-2xl font-bold">
            ...
            <p className="text-lg">
              Phone: <a href="tel:+19053216067" className="text-blue-600 underline hover:text-blue-800">+1-905-321-6067</a>
            </p>
        </div>
    </form>
  );
