...
export default function AerospaceAudits() {
  return (
    <>
      <Head>
        <title>SHANFE | Aerospace Compliance Audits</title>
        <meta
          name="description"
      ...
      <div className="w-full">
              <Image className='w-full relative' src='/images/aerospace/audits-hero.png' width={2000} height={2000} alt='Compliance Audits-SHANFE conducts comprehensive compliance audits aligned with Canadian
            Standards to ensure operational safety, regulatory adherence, and risk reduction.' />
            </div>

      <main className="flex flex-col items-center gap-20 p-10 max-w-7xl mx-auto mobile:p-8">
        <div className="flex flex-row gap-10 pt-10 mobile:flex-col mobile:items-center">
        <Image className='' src='/images/aerospace/shanfeaerospace.png' width={200} height={50} alt='Compliance Audits-SHANFE conducts comprehensive compliance audits aligned with Canadian
            Standards to ensure operational safety, regulatory adherence, and risk reduction.' />
        <div className="flex flex-col gap-5 max-w-3xl">
            <h2 className="text-4xl font-bold">
              Advancing Safety Where Every Decision Matters
            </h2>
            <p className="text-lg max-w-3xl">
              From hypoxia awareness training to aerospace consulting and compliance audits, Shanfe Aerospace equips organizations with the expertise to operate safely, confidently, and in accordance with Canadian standards.
            </p>
          </div>
        </div>
          <div className="text-Chocolate shadow-xl flex flex-row w-full gap bg-Eggshell items-center p-10 gap-10 rounded-3xl relative mobile:flex-col">
                       <Image className="rounded-3xl" src="/images/aerospace/aerospace-photo06.png" width={450} height={350} alt="" />
                          <div className="gap-5 flex flex-col">
                           <h1 className="text-5xl font-bold tablet:text-center">Hypobaric Operations</h1>
                            <p>Strengthening compliance, reducing risk. Comprehensive aerospace compliance audits designed to identify risks, strengthen safety programs, and support regulatory compliance. </p>
                        </div>
            </div>
